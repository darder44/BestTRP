...
Begin VB.Form frm_Report_DeliveryTrack 
   Caption         =   "客戶到貨追蹤表"
   ClientHeight    =   6300
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdSaveToText 
         ...
         Height          =   870
         Left            =   5880
         Picture         =   "frm_Report_DeliveryTrack.frx":0000
         Style           =   1  '圖片外觀
         TabIndex        =   15
         Top             =   1200
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd2Excel 
         ...
         Height          =   870
         Left            =   5880
         Picture         =   "frm_Report_DeliveryTrack.frx":030A
         Style           =   1  '圖片外觀
         TabIndex        =   3
         Top             =   240
         Width           =   1065
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   870
         Left            =   7080
         Picture         =   "frm_Report_DeliveryTrack.frx":1604
         Style           =   1  '圖片外觀
         TabIndex        =   5
         Top             =   1200
         Width           =   1065
      ...
      Begin VB.CommandButton cmdReset 
         ...
         Height          =   870
         Left            =   7080
         Picture         =   "frm_Report_DeliveryTrack.frx":2B216
         Style           =   1  '圖片外觀
         TabIndex        =   4
         Top             =   240
         Width           =   1065
      ...
      Begin VB.CommandButton cmdQuery 
         ...
         Height          =   870
         Left            =   4680
         Picture         =   "frm_Report_DeliveryTrack.frx":2B528
         Style           =   1  '圖片外觀
         TabIndex        =   2
         Top             =   240
         Width           =   1065
   ...
   End
End
Attribute VB_Name = "frm_Report_DeliveryTrack"
...
With MyXlsApp
    ...
    '備份檔案
    If Dir("C:\LTKK01\到貨追蹤", vbDirectory) = "" Then MkDirs "C:\LTKK01\到貨追蹤"
    .ActiveWorkbook.SaveAs "C:\LTKK01\到貨追蹤\到貨追蹤_" & Format(Now, "yyyymmddhhMMss") & ".xls"
...
str_SQL = "select * from gv_deliverytrack where 1 = 1 "

'訂單日期
chc_Orderdate = ""
If Len(txtOrderDateS.Text) > 0 And Len(txtOrderDateE.Text) > 0 Then
   chc_Orderdate = "and 訂單日期 between '" & txtOrderDateS.Text & "' and '" & txtOrderDateE.Text & "' "
ElseIf Len(txtOrderDateS.Text) > 0 And Len(txtOrderDateE.Text) = 0 Then
   chc_Orderdate = "and 訂單日期 = '" & txtOrderDateS.Text & "' "
ElseIf Len(txtOrderDateS.Text) = 0 And Len(txtOrderDateE.Text) > 0 Then
   chc_Orderdate = "and 訂單日期 = '" & txtOrderDateE.Text & "' "
End If

'到貨日期
chc_DeliveryDate = ""
If Len(txtDeliveryDateS.Text) > 0 And Len(txtDeliveryDateE.Text) > 0 Then
   chc_DeliveryDate = "and 到貨日期 between '" & txtDeliveryDateS.Text & "' and '" & txtDeliveryDateE.Text & "' "
ElseIf Len(txtDeliveryDateS.Text) > 0 And Len(txtDeliveryDateE.Text) = 0 Then
   chc_DeliveryDate = "and 到貨日期 = '" & txtDeliveryDateS.Text & "' "
ElseIf Len(txtDeliveryDateS.Text) = 0 And Len(txtDeliveryDateE.Text) > 0 Then
   chc_DeliveryDate = "and 到貨日期 = '" & txtDeliveryDateE.Text & "' "
End If

'組合字串
str_SQL = str_SQL & chc_Orderdate & chc_DeliveryDate & " and 貨主 ='" & Combo1.Text & "'order by 訂單日期 ,客戶名稱, 料號 "
...
'    Combo1.ListIndex = 0
    ...
    txtOrderDateS.Text = Format(Now - 2, "YYYYMMDD")
