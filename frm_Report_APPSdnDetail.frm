...
If Len(RTrim(cboStorerKey)) = 0 Then MsgBox "請選擇貨主編號!!", 16, Me.Caption: Exit Sub
...
If Len(RTrim(strSelected)) > 0 Then str_SQL = str_SQL & " and 訂單類別 in ( " & strSelected & "'') "
