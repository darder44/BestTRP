...
For i = 0 To List1.ListCount - 1
    If List1.Selected(i) Then
        If (List1.List(i) = "配置箱數" Or List1.List(i) = "配置個數" Or List1.List(i) = "配置總個數" Or List1.List(i) = "配置總重量" Or List1.List(i) = "配置總材積") Then
...
For i = 0 To OrderType.ListCount - 1
    ...
    End If
Next
If Len(strTmp) > 0 Then str_SQL = str_SQL & "and 訂單類別 in (" & Left(strTmp, Len(strTmp) - 1) & ") "
...
For i = 0 To Lot6.ListCount - 1
    ...
    End If
Next
If Len(strTmp) > 0 Then str_SQL = str_SQL & "and 配置倉別 in (" & Left(strTmp, Len(strTmp) - 1) & ") "
...
'批號
If (Len(RTrim(Text3.Text)) > 0 And Len(RTrim(Text4.Text)) = 0) Or (Len(RTrim(Text3.Text)) = 0 And Len(RTrim(Text4.Text)) > 0) Then str_SQL = str_SQL & "and 配置批號 = '" & RTrim(Text3.Text) & RTrim(Text4.Text) & "' "
If (Len(RTrim(Text3.Text)) > 0 And Len(RTrim(Text4.Text)) > 0) Then str_SQL = str_SQL & "and 配置批號 between '" & RTrim(Text3.Text) & "'and'" & RTrim(Text4.Text) & "' "

'WMS單號
If (Len(RTrim(Text5.Text)) > 0 And Len(RTrim(Text6.Text)) = 0) Or (Len(RTrim(Text5.Text)) = 0 And Len(RTrim(Text6.Text)) > 0) Then str_SQL = str_SQL & "and WMS單號 = '" & RTrim(Text5.Text) & RTrim(Text6.Text) & "' "
If (Len(RTrim(Text5.Text)) > 0 And Len(RTrim(Text6.Text)) > 0) Then str_SQL = str_SQL & "and WMS單號 between '" & RTrim(Text5.Text) & "'and'" & RTrim(Text6.Text) & "' "
...
'入庫日期
If (Len(RTrim(Text1.Text)) > 0 And Len(RTrim(Text2.Text)) = 0) Or (Len(RTrim(Text1.Text)) = 0 And Len(RTrim(Text2.Text)) > 0) Then str_SQL = str_SQL & "and 到貨日 = '" & RTrim(Text1.Text) & RTrim(Text2.Text) & "' "
If (Len(RTrim(Text1.Text)) > 0 And Len(RTrim(Text2.Text)) > 0) Then str_SQL = str_SQL & "and 到貨日 between '" & RTrim(Text1.Text) & "'and'" & RTrim(Text2.Text) & "' "
