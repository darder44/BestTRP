...
Begin VB.Form frm_Report_TKRSDNReturnList 
   Caption         =   "退貨回單檢核表"
   ClientHeight    =   6300
   ClientLeft      =   60
   ClientTop       =   345
   ...
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frm_Report_TKRSDNReturnList.frx":0000
   ScaleHeight     =   6300
   ScaleWidth      =   10335
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdSaveToText 
         ...
         Height          =   870
         Left            =   7680
         Picture         =   "frm_Report_TKRSDNReturnList.frx":0342
         Style           =   1  '圖片外觀
         TabIndex        =   23
         Top             =   1200
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdPreView 
         ...
         Height          =   870
         Left            =   120
         Picture         =   "frm_Report_TKRSDNReturnList.frx":064C
         Style           =   1  '圖片外觀
         TabIndex        =   20
         Top             =   1200
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   870
         Left            =   3480
         Picture         =   "frm_Report_TKRSDNReturnList.frx":0956
         Style           =   1  '圖片外觀
         TabIndex        =   19
         Top             =   1320
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd2Excel 
         ...
         Height          =   870
         Left            =   7680
         Picture         =   "frm_Report_TKRSDNReturnList.frx":0C60
         Style           =   1  '圖片外觀
         TabIndex        =   3
         Top             =   240
         Width           =   1065
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   870
         Left            =   8880
         Picture         =   "frm_Report_TKRSDNReturnList.frx":1F5A
         Style           =   1  '圖片外觀
         TabIndex        =   5
         Top             =   1200
         Width           =   1065
      ...
      Begin VB.CommandButton cmdReset 
         ...
         Height          =   870
         Left            =   8880
         Picture         =   "frm_Report_TKRSDNReturnList.frx":2BB6C
         Style           =   1  '圖片外觀
         TabIndex        =   4
         Top             =   240
         Width           =   1065
      ...
      Begin VB.CommandButton cmdQuery 
         ...
         Height          =   870
         Left            =   6480
         Picture         =   "frm_Report_TKRSDNReturnList.frx":2BE7E
         Style           =   1  '圖片外觀
         TabIndex        =   2
         Top             =   240
         Width           =   1065
   ...
   End
End
Attribute VB_Name = "frm_Report_TKRSDNReturnList"
...
cnAccess.Execute "Delete From 退貨回單檢核表", RowsAffect, adExecuteNoRecords

Dim rs_Access As New ADODB.Recordset
rs_Access.Open "退貨回單檢核表", cnAccess, adOpenStatic, adLockOptimistic
...
With MSAccessAP
    ...
    .DoCmd.OpenReport "退貨回單檢核表", acViewPreview
    .Visible = True
...
With MSAccessAP
    ...
    '直接列印至印表機
    .Visible = False
    .DoCmd.OpenReport "退貨回單檢核表", acViewNormal
...
str_SQL = "select 通路別 = isnull(t1m.channel,'') " & _
            ",客戶名稱 = isnull(t1m.short_name,'') " & _
            ",地址別中文 = isnull(t1m.full_name,'') " & _
            ",到貨日 = isnull(s2.arrive_date,'') " & _
            ",訂單類別 = isnull(s2.priority,'') " & _
            ...
            "from trp01m t1m join sdn02t s2 on s2.consigneekey = t1m.consigneekey " & _
            "Where s2.priority = 'R' "
...
If Len(txtDeliveryDateS.Text) > 0 And Len(txtDeliveryDateE.Text) > 0 Then
   chc_DeliveryDate = "and convert(Char(8),arrive_date,112) between '" & txtDeliveryDateS.Text & "' and '" & txtDeliveryDateE.Text & "' "
